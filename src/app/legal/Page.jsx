      ...
      <section className="font-medium">
        <div className="wrapper pt-32 sm:pt-36 lg:pt-36 xl:pt-40 pb-12 md:pb-16 lg:pb-32">
          <h1 className="leading-tight font-bold mb-8 lg:mb-12 xl:mb-16">
            Termos <span className="text-neutral-400">Legais</span>
          </h1>
          <div className="flex items-center gap-16">
            <div className="flex flex-col gap-8 text-base sm:text-lg lg:text-xl xl:text-2xl text-neutral-200 max-w-[60ch]">
              ...
              <p>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Praesentium quod eveniet officiis quo est facere labore ipsam.
                Debitis voluptate consequatur ut obcaecati voluptatibus nobis
                nulla nihil, illum odit tempore magni.
              </p>
            </div>
          </div>
        </div>
