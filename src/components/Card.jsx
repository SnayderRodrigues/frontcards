...
const Card = ({ tool }) => {
  ...
  return (
    <div
      className="group w-full relative flex flex-col justify-between gap-4 p-4 bg-neutral-900 border-2 border-neutral-800 rounded-xl overflow-hidden transition-colors ease-in cursor-pointer md:hover:border-neutral-600"
      onClick={handleClick}
    >
