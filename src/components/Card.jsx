...
const Card = ({ tool }) => {
  ...
  return (
    <div
      className="w-full flex flex-col justify-between gap-4 p-[20px] bg-neutral-900 border-2 border-neutral-800 rounded-xl overflow-hidden transition-colors ease-in cursor-pointer md:hover:border-neutral-600"
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-4">
        <div className="flex items-start justify-between gap-3">
          <span className="text-xl md:text-2xl font-bold mt-[6px] md:mt-[1px]">
            {tool.title}
          </span>
          <button
            aria-label="Favorito"
            className={`group shrink-0 w-[40px] md:w-[34px] aspect-square relative flex items-center justify-center text-sm font-medium text-white
            ${
