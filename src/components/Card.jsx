...
const Card = ({ tool }) => {
  ...
  return (
    <div
      className="w-full flex flex-col justify-between gap-4 p-[20px] bg-neutral-900 rounded-xl overflow-hidden transition-colors ease-in cursor-pointer md:hover:border-neutral-600"
